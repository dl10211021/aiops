...
const PARAM_HELP_TEXT: Record<string, string> = {
  ...
  auth_type: '控制 Token 写入方式。Basic 用户名密码会优先使用上方账号密码自动生成 Authorization。',
  auth_header: 'Token 或 API Key 使用的请求头，默认 Authorization；部分平台可改为 X-API-Key、X-Auth-Token。',
  custom_headers: '每行一个 Header，格式为 Header-Name: value；也支持 JSON 对象。',
