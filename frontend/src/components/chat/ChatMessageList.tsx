...
export default function ChatMessageList({
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-0 flex-1 space-y-3 overflow-y-auto bg-[radial-gradient(circle_at_18%_8%,rgba(40,208,168,0.08),transparent_24rem),linear-gradient(180deg,rgba(9,19,34,0.74),rgba(8,17,30,0.94))] px-4 py-4 lg:px-6 lg:py-5"
    >
