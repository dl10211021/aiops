...
class TestAssetProtocolLayer(unittest.TestCase):
    ...
    def test_special_asset_capability_overrides_are_applied(self):
        ...
        self.assertEqual(by_id["kafka_client"]["capability"]["maturity"], "generic")
        ...
        self.assertEqual(by_id["jvm"]["capability"]["maturity"], "generic")
        ...
        self.assertEqual(by_id["ipmi"]["capability"]["maturity"], "generic")
        ...
        self.assertEqual(by_id["ldap"]["capability"]["maturity"], "generic")
