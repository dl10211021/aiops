...
TOOLSET_LABELS: dict[str, str] = {
    ...
    "http-api": "通用 API 工具",
    "hermes-browser": "Hermes 浏览器工具",
    "hermes-clarify": "Hermes 交互工具",
    "hermes-code_execution": "Hermes 代码执行",
    "hermes-cronjob": "Hermes 定时任务",
    "hermes-delegation": "Hermes 子代理委派",
    "hermes-file": "Hermes 文件工具",
    "hermes-memory": "Hermes 记忆工具",
    "hermes-messaging": "Hermes 消息工具",
    "hermes-session_search": "Hermes 会话搜索",
    "hermes-skills": "Hermes 技能工具",
    "hermes-terminal": "Hermes 进程工具",
    "hermes-todo": "Hermes 任务清单",
    "hermes-tts": "Hermes 语音工具",
    "hermes-vision": "Hermes 视觉工具",
    "hermes-web": "Hermes 联网工具",
    "interaction": "交互确认",
    "knowledge": "知识库",
